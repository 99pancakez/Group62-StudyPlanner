  ...
  const getInitialAnswers = () => {
    try {
      ...
      return {
        ...
        intakeSemester: INTAKE_OPTIONS.includes(parsed.intakeSemester)
          ? parsed.intakeSemester
          : "",
        semester_id: parsed.intakeSemester
          ? String(INTAKE_TO_SEMESTER_ID[parsed.intakeSemester])
          : "",
      };
    } catch {
  ...
  const handleChange = (e, key) => {
    ...
    setAnswers((prev) => {
      const updated = {
        ...
        [key]: value,
        ...(key === "intakeSemester"
          ? { semester_id: INTAKE_TO_SEMESTER_ID[value] || "" }
          : {}),
      };
